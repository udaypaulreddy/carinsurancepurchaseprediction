"""astudy_onacar_insurancepurchase_prediction URL Configuration
...
from astudy_onacar_insurancepurchase_prediction import settings
...
urlpatterns = [
    ...
    url(r'^predict_car_Insurance_purchase/$', remoteuser.predict_car_Insurance_purchase, name="predict_car_Insurance_purchase"),
    ...
    url(r'^Find_car_Insurance_purchase_prediction_Type_Ratio/$', serviceprovider.Find_car_Insurance_purchase_prediction_Type_Ratio, name="Find_car_Insurance_purchase_prediction_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^car_Insurance_purchase_prediction/$', serviceprovider.car_Insurance_purchase_prediction, name="car_Insurance_purchase_prediction"),
