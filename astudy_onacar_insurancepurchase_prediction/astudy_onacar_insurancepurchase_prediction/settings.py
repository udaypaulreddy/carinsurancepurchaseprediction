...
ROOT_URLCONF = 'astudy_onacar_insurancepurchase_prediction.urls'
...
WSGI_APPLICATION = 'astudy_onacar_insurancepurchase_prediction.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'astudy_onacar_insurancepurchase_prediction',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
